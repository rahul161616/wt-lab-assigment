...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['profile'])) {
        ...
        if (
            ...
            VALUES ('$name', '$email', '$password', '$dob', '$favourite_color', '$weight', '$gender', '$hobbies', '$nationality','$new_name ')";
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE students SET name='$name',email='$email',password='$password',dob='$dob',favourite_color='$color',weight=$weight,gender='$gender',hobbies='$hobbies',nationality='$nationality' WHERE id='$id'";
